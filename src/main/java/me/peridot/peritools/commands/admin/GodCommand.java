...
public class GodCommand extends PeriCommand {

    private final LangAPI lang;

    public GodCommand(PeriTools plugin) {
        super(plugin, "god", "/{LABEL} <gracz>", "Ulecza konkretnego gracza, daje mu pelne zycie, nasycenie oraz usuwa z niego wszystkie efekty", "peritools.cmd.god", "immortality");
